...
describe("Format Helper - duration", () => {
    ...
    it('should return 10:00 if 3600000 is passed as argument', () => {
        expect(duration(60 * 60 * 1000)).toBe('01:00');
    });
    it('should return NaN:NaN if string is passed as argument', () => {
        expect(duration('afsdfas')).toBe('NaN:NaN');
    });
    it('should return NaN:NaN if undefined is passed as argument', () => {
        expect(duration()).toBe('NaN:NaN');
    });
})
